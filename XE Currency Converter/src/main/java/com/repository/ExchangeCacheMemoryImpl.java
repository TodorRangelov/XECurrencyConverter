...
import static com.console.helper.DataTimeHelper.getCurrentTimeAsString;

@Component
public class ExchangeCacheMemoryImpl implements ExchangeCacheMemory<ExchangePair, String> {
